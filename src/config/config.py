...
RECONSTRUCTED_CT_VOLUME_PROJECTION_DOMAIN = Path("/home/woody/iwi5/iwi5293h/reconstructed_ct_volumes_projection_domain") #reconstructed ct volume generated from predicted sinograms of projection domain models
# Where to save model checkpoints (scratch)

CKPT_DIR=Path("/home/vault/iwi5/iwi5293h/models")
CKPT_DIR_PROJECTION_DOMAIN=Path("/home/vault/iwi5/iwi5293h/models_projection_domain")
