...
#python3 image_domain/preprocessing/dicom_to_sinogram_test.py
#python3 image_domain/preprocessing/add_motion_artifacts_test.py
...
#python3 image_domain/training/train.py --model restormer --batch-size 1 --patch 128
#python3 image_domain/training/train.py --model swinir --batch-size 2 --patch 128
#python3 image_domain/training/train.py --model replk --batch-size 1 --patch 128
...
#evaluation steps
#python3 image_domain/evaluation/final_evaluation.py --model unet --clean-folder clean
#python3 image_domain/evaluation/final_evaluation.py --model mr_lkv --clean-folder clean --no-lpips --no-vif
#python3 image_domain/evaluation/final_evaluation.py --model replknet --clean-folder clean
#python3 image_domain/evaluation/final_evaluation.py --model swinir --clean-folder clean
#python3 image_domain/evaluation/final_evaluation.py --model restormer --clean-folder clean
...
#python3 projection_domain/preprocessing/dicom_to_sinogram_test.py
#python3 projection_domain/preprocessing/add_motion_artifacts_test.py
...
#evaluation commands
#python3 projection_domain/evaluation/final_evaluation.py --model unet --clean-folder clean
#python3 projection_domain/evaluation/final_evaluation.py --model mr_lkv --clean-folder clean
#python3 projection_domain/evaluation/final_evaluation.py --model replknet --clean-folder clean
#python3 projection_domain/evaluation/final_evaluation.py --model swinir --clean-folder clean
#python3 projection_domain/evaluation/final_evaluation.py --model restormer --clean-folder clean
